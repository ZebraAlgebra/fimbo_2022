pic1 = document.getElementsByClassName('question_sheet_pic')[0];
pic2 = document.getElementsByClassName('location_sheet_pic')[0];
pic3 = document.getElementsByClassName('relation_sheet_pic')[0];
